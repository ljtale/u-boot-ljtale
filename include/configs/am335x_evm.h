...
/* jie start: config server ip and client ip when tftp is used */
#define CONFIG_SERVERIP 192.168.1.8
#define CONFIG_IPADDR 192.168.1.10
#define CONFIG_BOOTARGS "console=ttyO0,115200n8 " \
                                "quiet root=/dev/mmcblk0p2 ro rootfstype=ext4 rootwait"
/* jie end */
#ifndef CONFIG_SPL_BUILD
